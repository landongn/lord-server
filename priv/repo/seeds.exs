...
Repo.insert!(%Server.Entity{
    ...
    m_health: 50,
    m_mana: 25,
    death_msg: "\"My death will be avenged!\", the orc cries as it slumps to the ground.",
    kill_msg: "\"More bones for my soup, I see.\", the orc lets loose a howl",
    gold: 50,
    weapon: "Dingy Mace"
})

Repo.insert!(%Server.Entity{
    name: "an Evil Wood Nymph",
    level: 2,
    strength: 13,
    endurance: 20,
    s_atk: "bix_att",
    ...
    m_health: 40,
    m_mana: 25,
    death_msg: "You shudder to think of what would have happened, had you given in.",
    kill_msg: "\"Time for some fun!\", the Nymph exclaims as you black out, for good.",
    gold: 160,
    weapon: "Flirtatious Behavior"
})
...
Repo.insert!(%Server.Entity{
    ...
    m_health: 65,
    m_mana: 25,
    death_msg: "You knock Gath down, ignoring his constant groaning..",
    kill_msg: "Gath grunts and leaves your corpse for the wolves as he moves back into the trees.",
    gold: 160,
...
Repo.insert!(%Server.Entity{
    ...
    m_health: 65,
    m_mana: 25,
    death_msg: "Pitting your wisdom against his brawn has one this battle",
    kill_msg: "The Wild Man ferociously tears at your armor, into your flesh, and hits bone as you scream for mercy. \n The man brandishes a giant stone, and brings it down upon your sternum with a crunch.",
    gold: 160,
    weapon: "Filthy Hands"
})
...
Repo.insert!(%Server.Entity{
    ...
    m_health: 90,
    m_mana: 25,
    death_msg: "You consider this a message to her people, \"STAY AWAY!\".",
    kill_msg: "As a crushing blow lands upon your skull, Brorandia stands at the ready as blood splatters across her face. She lets loose a warcry as she winds up the ultimate blow.",
    gold: 360,
    weapon: "Massive Iron Mace"
})
...
Repo.insert!(%Server.Entity{
    ...
    m_health: 50,
    m_mana: 25,
    death_msg: "The beast is now still. ",
    kill_msg: "The ravenous hound lunges for your neck, puncturing your artery.  It begins to devour your flesh before you've even had a chance to die properly. ",
    gold: 360,
    weapon: "Fangs"
})

Repo.insert!(%Server.Entity{
    name: "a Magical Evil Gnome",
    level: 3,
    strength: 24,
    endurance: 20,
    s_atk: "jumpf_1",
    ...
    m_health: 120,
    m_mana: 25,
    death_msg: "The Gnome's small body is covered in a deep red blood.",
    kill_msg: "The Gnome begins to speak, but it's too quiet to hear. As you lunge forward to strike, you step upon a pentagram on the forest floor that instantly burns you to a crisp where you stand.",
    gold: 360,
    weapon: "Fangs"
})
